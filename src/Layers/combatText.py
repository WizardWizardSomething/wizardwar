...
class CombatText(cocos.layer.Layer):
    def __init__(self):
        ...
        self.kills_amount = label.labelClass(self.kills, False, 20)
    ...
    def updateHP(self, newHealth):
        self.health_amount = label.labelClass(newHealth, False, 20)

    def incrementKills(self, newKills):
        self.kills_amount = label.labelClass(newKills, False, 20)